...
public:
    ...
    TransportTransmitter(eul::logger::logger_factory& logger_factory, DataLinkTransmitter& datalink_transmitter, const eul::time::i_time_provider& time_provider);
...
private:
    ...
    DataLinkTransmitter& datalink_transmitter_;
...
TransportTransmitter<DataLinkTransmitter, Configuration>::TransportTransmitter(
    eul::logger::logger_factory& logger_factory, DataLinkTransmitter& datalink_transmitter, const eul::time::i_time_provider& time_provider)
    ...
    , timer_(time_provider)
{
    ...
    datalink_transmitter_.on_success([this]
    {
    ...
    datalink_transmitter_.on_failure([this](TransmissionStatus status){
    ...
    const StreamType& payload, const CallbackType& on_success, const CallbackType& on_failure)
{
    ...
    Configuration::execution_queue.push_front(lifetime_, [this]
    {
        ...
        datalink_transmitter_.send(data);
